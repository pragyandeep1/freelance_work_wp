					...
					'withdraw_request' => array(
						...
						'options' => array(
							...
							'withdraw_info' => array(
								...
								'identity verification' => esc_html__( '', 'workreap' ),
								'html' => ' %user_name% — To display freelancer name who submit the withdraw request<br/>
											%user_link% — To display the freelancer link who sends the withdraw request<br/>
