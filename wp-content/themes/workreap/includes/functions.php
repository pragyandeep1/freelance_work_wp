 ...
 * @return sizes
 */
add_image_size('workreap_freelancer_banner', 1920, 400, false); 
add_image_size('workreap_blog_large', 1140, 400, false); 
add_image_size('workreap_blog_small', 730, 240, false); 
add_image_size('workreap_service_details', 670, 370, false);
add_image_size('workreap_classic_grid', 540, 240, false); 
add_image_size('workreap_blog_grid', 355, 352, false);
add_image_size('workreap_service', 352, 200, false);
add_image_size('workreap_top_freelancer_v2', 320, 220, false);
add_image_size('workreap_freelancers_v3', 290, 215, false);
add_image_size('workreap_portfolio_thumbnail', 235, 149, false);
add_image_size('workreap_freelancer', 225, 225, false);
...
if (!function_exists('workreap_count_unread_cometchat_msgs')) {
	...
	add_image_size( 'workreap_freelancer_banner', 800, 350 );
}