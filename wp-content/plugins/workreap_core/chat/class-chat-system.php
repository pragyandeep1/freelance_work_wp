								...
								<div class="wt-formtheme wt-formpopup">
									<fieldset class="wt-replaybox">
										...
										<div class="form-group wt-btnarea">
											...
											<a href="#" onclick="event_preventDefault(event);" class="wt-btn wt-send-offer" data-invitetype="<?php echo esc_attr($type); ?>" data-status="unread" data-msgtype="modal" data-projectid="" data-receiver_id="<?php echo esc_attr($userId);?>"><?php esc_html_e('Send offer','workreap_core');?></a>
										</div>
									</fieldset>
								</div>
							</form>
