				...
				<div class="wt-joinnowpopup-wrap">
					...
					<form class="wt-formtheme wt-joinnow-form single-social-style" id="wt-single-joinnow-form" method="post">
						<fieldset>
							...
							<!-- Custom code OKCL learner code	-->

							<div class="form-group">
								<input type="number" id="learnercode"  name="learnercode" class="form-control" value="" required min="16" max="16" maxlength="16" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  placeholder="OKCL Learner Code">
							</div>
							<script>
									...
									if (this.value == "freelancer") {
										...
										jQuery("#learnercode").show();
										jQuery("#learnercode").attr("required", true);
										jQuery("#learnercode").attr("min", 16);
										jQuery("#learnercode").attr("max", 16);
									
									}else {
									
										jQuery("#learnercode").hide();
										jQuery("#learnercode").removeAttr("required");
							...
							<!-- End: Custom code OKCL learner code	-->
